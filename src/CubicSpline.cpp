...
void CubicSpline::particleToGrid(XMFLOAT2 particlePos, XMFLOAT2 particleVel,
...
XMFLOAT2 CubicSpline::gridToParticle(vector<XMFLOAT2>& oldVel, XMFLOAT2 particlePos,
